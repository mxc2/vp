<?php
  ...
  //Tegeleme küpsistega (nommm cookies)
  //setcookie  see peab olema enne <html> koodi algust
  //(küpsise nimi, väärtus, aegumine, path (kataloog), domeen, https, http-only
  setcookie("vpvisitorname", $_SESSION["userfirstname"] ." " .$_SESSION["userlastname"], time() + (86400 * 8), "/~marcsim/", "greeny.cs.tlu.ee", isset($_SERVER["HTTPS"]), true);
  
  //Vaatame kas cookie on olemas
